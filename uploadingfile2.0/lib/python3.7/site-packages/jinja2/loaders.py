...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'uploadpage.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/uploadpage.html'`` the file from the app1 package is loaded,
    by loading ``'app2/uploadpage.html'`` the file from the second.
    """
